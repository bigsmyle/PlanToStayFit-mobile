...
title: string = 'Map project';
  ...
  constructor(  public navCtrl: NavController, private authService: AuthService,private ngZone: NgZone,private mapsAPILoader: MapsAPILoader, private formBuilder: FormBuilder) {
